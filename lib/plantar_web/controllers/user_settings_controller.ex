defmodule PlantarWeb.UserSettingsController do
  use PlantarWeb, :controller

  alias Plantar.Accounts
  alias PlantarWeb.UserAuth
  ...
  def update_name(conn, %{"current_password" => password, "user" => user_params}) do
    user = conn.assigns.current_user

    case Accounts.update_name(user, user_params, password) do
      {:ok, _user} ->
        conn
